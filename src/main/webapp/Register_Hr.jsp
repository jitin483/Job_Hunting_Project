														...
														<form action="register" method="post">
															...
															<div class="row">
																<div class="col-sm-12 col-xl-3 m-b-30">
																	...
																	<input name="forpost" type="text" placeholder="ForPost"
																		class="form-control">
																</div>
																<div class="col-sm-12 col-xl-3 m-b-30">
															...
															<div class="row">
																...
																<div class="col-sm-12 col-xl-3 m-b-30">
																	<h4 class="sub-title">hrStatus</h4>
																	<input name="hrstatus" type="text" placeholder="hrStatus"
																		class="form-control">
																</div>
