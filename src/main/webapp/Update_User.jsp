...
<head>
<title>Job Hunting Portal - User Update</title>
														...
														<form action="updateform1" method="post">
															<div class="row">
																<div class="col-sm-12 col-xl-3 m-b-30">
																	...
																	<input name="id" type="number" placeholder="id" value ="${user.id}"
																		class="form-control">
																</div>
																<div class="col-sm-12 col-xl-3 m-b-30">
															...
															<div class="row">
																...
																<div class="col-sm-12 col-xl-3 m-b-30">
																	...
																	<input name="mobile" type="text" placeholder="mobile" value ="${user.mobile}"
																		class="form-control">
																</div>
															</div>
															<div class="row">
																<div class="col-sm-12 col-xl-3 m-b-30">
																	...
																	<input name="education" type="text" placeholder="Education" value ="${user.education}"
																		class="form-control">
																</div>
