...
<head>
<title>Job Hunting Portal -  View Job Details</title>
											...
											<div class="row  ml-5">
												<div class="col-sm-12">
													...
													<div class="card">
														...
														<form action="viewJobDetail" method="post">
															<div class="row ml-5 mr-5">
																<div class="col-sm-12 col-xl-3 m-b-30">
																	<h4 class="sub-title">JOB ID</h4>
																	<h6>${job.id}</h6>
															...
															<div class="row ml-5 mr-5">
																...
																<div class="col-sm-12 col-xl-3 m-b-30">
                                                                  ...
                                                                  <button class="btn btn-warning ml-5 " onclick="history.back()">Go Back</button>
															</div>
														</form>
														</div>
													</div>
