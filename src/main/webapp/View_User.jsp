...
<head>
<title>Job Hunting Portal -  View User Details</title>
											...
											<div class="row  ml-5">
												<div class="col-sm-12">
													...
													<div class="card">
														...
														<button class="btn btn-warning w-10" onclick="history.back()">Go Back</button>
														</div>
													</div>
