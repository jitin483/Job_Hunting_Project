                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline">
                                                    <h4>View Registered Hr Executive</h4>
                                                    ...
                                                    <table id="compact" class="table compact table-striped table-bordered nowrap">
                                                        ...
                                                        <c:forEach items="${Hrlist}" var="h">
															<tr>
																...
																<td scope="row"><a href="updatehr?id=${h.id}"class="btn btn-primary">Update</a>
																<a href="viewhr?id=${h.id}"class="btn btn-warning">View</a></td>
