...
<head>
<title>Job Hunting Portal - HR Add jobs</title>
															...
															<form action="jobs" method="post">
																<div class="row">
																	<div class="col-sm-12 col-xl-3 m-b-30">
																		...
																		<input name="hrName" type="text" placeholder="HR Name" readonly value="${hr.name}"
																			class="form-control">
																	</div>
																	<div class="col-sm-12 col-xl-3 m-b-30">
																		<h4 class="sub-title">Company Name</h4>
																		<input name="companyName" type="text"
																			placeholder="Company name" class="form-control" readonly  value="${hr.companyname}">
																	</div>
																	<div class="col-sm-12 col-xl-3 m-b-30">
																		<h4 class="sub-title">Job Profile</h4>
																		<input name="jobprofile" type="text"
																			placeholder="job profile" class="form-control">
																	</div>
																	<div class="col-sm-12 col-xl-3 m-b-30">
																...
																<div class="row">
																	...
																	<div class="col-sm-12 col-xl-3 m-b-30">
																		<h4 class="sub-title">Skills Required</h4>
																		<input name="skillsRequired" type="text"
																			placeholder="Skills Required" class="form-control">
																	</div>
																	
																	<div class="col-sm-12 col-xl-3 m-b-30">
																		<h4 class="sub-title">Experience Required</h4>
																	...
																	<div class="col-sm-12 col-xl-3 m-b-30">
																		...
																		<input name="validTill" type="date"
																			placeholder="MM/DD/YYYY" class="form-control" required>
																	</div>
																	<div class="col-sm-12 col-xl-3 m-b-30">
                                                                        <h4 class="sub-title"> job description</h4>
                                                                        <textarea = "description" rows="5" cols="30" name="jobDescription"></textarea>
                                                                    </div>
																</div>
