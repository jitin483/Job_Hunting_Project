...
<head>
    <title>Job Hunting Portal - Manager Profile</title>
                                                                ...
                                                                <div class="media-body row">
                                                                    <div class="col-lg-12">
                                                                        <div class="user-title">
                                                                            <h2> ${hr.name}</h2>
                                                                            <span class="text-white"> ${hr.skills}</span>
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                                                                            ...
                                                                                            <table class="table">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td><a href="#!"><span class="__cf_email__" data-cfemail="4206272f2d02273a232f322e276c212d2f">${hr.email}</span></a></td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                        ...
                                                                        <div class="col-lg-12">
                                                                            <div class="general-info">
                                                                                <div class="row">
                                                                                                        ...
                                                                                                        <div class="form-radio">
                                                                                                            <div class="group-add-on">
                                                                                                                <div class="radio radiofill radio-inline">
                                                                                                                    <label>
                                                                                                <input type="radio" name="gender" checked=""><i class="helper"></i> Male
                                                                                            </label>
                                                                                                                </div>
                                                                                                                <div class="radio radiofill radio-inline">
                                                                                                                    <label>
                                                                                                <input type="radio" name="gender"><i class="helper"></i> Female
                                                                                            </label>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                    ...
                                                                                    <option value="${hr.maritalStatus}">---- ${hr.maritalStatus}----</option>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <div class="input-group">
                                                                                                            ...
                                                                                                            <input type="email" class="form-control" placeholder="Skype Id" value="">
                                                                                                        </div>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
