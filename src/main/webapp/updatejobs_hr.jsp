													...
													<div class="card">
														...
														<div class="card-block">
															<form action="updateform" method="post">
																...
																<div class="col-sm-12 col-xl-3 m-b-30">
                                                                        <h4 class="sub-title">HR-Name</h4>
                                                                        <input name="hrName" type="text" readonly
                                                                            placeholder="Username" value="${hr.hrName} " 
                                                                            class="form-control">
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-12 col-xl-3 m-b-30">
                                                                        ...
                                                                        <input name="companyName" type="text" readonly value="${hr.companyName}"
                                                                            placeholder="companyName" 
                                                                            class="form-control">
                                                                    </div>
																	<div class="col-sm-12 col-xl-3 m-b-30">
																		<h4 class="sub-title">Job Profile</h4>
																		<input name="jobprofile" type="text" placeholder="jobprofile"
																			value="${hr.jobprofile}" class="form-control">
																	</div>
																</div>
																<div class="row">
																	<div class="col-sm-12 col-xl-3 m-b-30">
																		...
																		<input name="location" type="text"
																			placeholder="location" value="${hr.location}"
																			class="form-control">
																	</div>
																	<div class="col-sm-12 col-xl-3 m-b-30">
																		<h4 class="sub-title">Job Type</h4>
																		<select class="form-control"
																			id="exampleFormControlSelect1" name="jobType">
																			<option selected value="${hr.jobType}">${hr.jobType}</option>
																	...
																	<div class="col-sm-12 col-xl-3 m-b-30">
																		<h4 class="sub-title">SkillsRequired</h4>
																		<input name="skillsRequired" type="text"
																			placeholder="skillsRequired" value="${hr.skillsRequired}"
																			class="form-control">
																	</div>
																	<div class="col-sm-12 col-xl-3 m-b-30">
																		<h4 class="sub-title">Experience</h4>
																		<input name="experience" type="text" placeholder="experience"
																			value="${hr.experience}" class="form-control">
																	</div>
																</div>
																<div class="row">
																	...
																	<div class="col-sm-12 col-xl-3 m-b-30">
																		...
																		<div>
																			<select class="form-control"
																				...
																				<option selected value="${hr.isActive}">${hr.isActive}</option>
																	...
																	<div class="col-sm-12 col-xl-3 m-b-30">
																		<h4 class="sub-title">Valid Upto</h4>
																		<input name="validTill" type="Date" value="${hr.validTill }"
