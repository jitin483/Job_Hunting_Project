														...
														<tbody>
															<c:forEach items="${job}" var="j">
																<tr>
																	...
																	<!--  <td scope="row"><a
																		href="applied?jobid=${j.id}&&userid=${userId}"> 
...
<a href="viewJobDetail?id=${j.id}" class="btn btn-warning">View</a>
<!-- Modal -->
<div class="modal fade-scale(40)" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Job Applied Successfully!</h5>
